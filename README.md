Podenok-sender
==============================================================================================
Знакома ли вам ситуация когда вы хотите сдать лабу, но вы не можете отправить ее преподавателю?<br>
...
---------------------------------------------------------------------------------------------
Для отправки лабораторной, небходимо заполнить поля: Фамилия, Имя, Отчество, Номер группы.<br>
